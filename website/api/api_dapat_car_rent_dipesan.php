...
if ($_SERVER['REQUEST_METHOD']=='POST') {
	...
	// cek apakah ada seat
    $query = " SELECT * FROM transaksi_rental, drivers, waktu_berangkat WHERE transaksi_rental.id_driver = drivers.id_driver AND id_customer = '$id_customer' AND waktu_berangkat.id_waktu_berangkat = transaksi_rental.waktu_peminjaman AND status_transaksi = '1' ";
