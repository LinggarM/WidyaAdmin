...
if ($_SERVER['REQUEST_METHOD']=='POST') {
	...
	// cek apakah ada seat
    $query = " SELECT * FROM transaksi_individu, drivers, waktu_berangkat WHERE transaksi_individu.id_driver = drivers.id_driver AND id_customer = '$id_customer' AND waktu_berangkat.id_waktu_berangkat = transaksi_individu.waktu_penjemputan AND (status_transaksi = '3' OR status_transaksi = '4')  ";
